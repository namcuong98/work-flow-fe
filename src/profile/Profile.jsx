            ...
            <div className="page-back">
              ...
              <div className="rim">
                ...
                <p className="mt-2">
                  ...
                  data. MySQL is used as the database. Due to the absence of any
                  similar references on the web to consult, the layout is
            ...
            <div className="page-back">
              ...
              <div className="rim border-l-2 border-main-color">
                <div className="ml-4 notify">
                  ...
                  <p className="mt-2 mb-1">
                    - Every day at 8 AM, you will receive an email notification
                    of the tasks you need to complete. Therefore, make sure to
                    register with your primary email and remember to check your
                    email at 8 AM daily.
                  </p>
                  <p className="mt-2 mb-1">
          ...
          <div className="book-page page-right turn" id="turn-3">
            ...
            <div className="page-font">
              ...
              <div className="rim">
                ...
                <span>
                  - Learn the basics of web programming including HTML, CSS, and
                  JavaScript, creating static web pages. Slice HTML and create
                  effects to make the web page smoother. Enhance the web's sales
                  performance and improve UX and UI for web users.
                </span>
                <div className="education">
                  <i className="fa-regular fa-calendar-days"></i>
                  <p>10/2023:</p>
                ...
                <span>
                  ...
                  page optimized for functionality, performance, bug fixing,...
                  Use libraries like Tailwind and Bootstrap to complete a web
                  page faster.
                </span>
                <div className="education">
                  <i className="fa-regular fa-calendar-days"></i>
